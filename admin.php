...
<div id="message" style="margin: 0">База Данных</div>
</div>
...
if($_POST['paswd']==$pass)
    ...
    <span class="grey">
HERE;
include('password6427032base.txt');
echo '</span>	</table>';
    ...
    <td width="100px">
    <span class="grey">Введен неверный пароль</span>
 ...
 <input type="hidden" name="try_to_login" id="try_to_login" value="1">
  <table align="center" cellpadding=0 cellspacing=7 border=0 width="40%">
   ...
   <tr>
    ...
    <td>
<div style="height:20px; margin:15px 0px">
